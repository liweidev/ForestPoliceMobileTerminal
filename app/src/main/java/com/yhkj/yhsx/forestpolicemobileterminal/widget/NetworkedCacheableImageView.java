...
import com.yhkj.yhsx.forestpolicemobileterminal.utils.SDK11;
...
import bitmapcache.CacheableBitmapDrawable;
import bitmapcache.CacheableImageView;
...
public class NetworkedCacheableImageView extends CacheableImageView {
    ...
    public NetworkedCacheableImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mCache = MyApplication.getApplication(context).getBitmapCache();
    }
