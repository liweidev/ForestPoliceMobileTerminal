...
import com.yhkj.yhsx.forestpolicemobileterminal.fragment.info_collection.basic_parameter.WoodCutAttachmentFragment;
import com.yhkj.yhsx.forestpolicemobileterminal.fragment.info_collection.basic_parameter.WoodCutInfomationFragment;
...
public class WoodCuttingActivity extends ParentActivity implements View.OnClickListener {
    ...
    protected int layoutResID() {
        return R.layout.activity_woodcutting;
    }
    ...
    private void addFragmentPager() {
        ...
        for(int i=0;i<2;i++){
            ...
            switch (i){
                case 0:
                    fragment=new WoodCutInfomationFragment();
                    break;

                case 1:
                    fragment=new WoodCutAttachmentFragment();
                    break;
            }
