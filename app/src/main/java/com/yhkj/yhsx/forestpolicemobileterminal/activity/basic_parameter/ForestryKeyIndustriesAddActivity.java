...
import com.yhkj.yhsx.forestpolicemobileterminal.fragment.info_collection.basic_parameter.ForestryAttachmentFragment;
import com.yhkj.yhsx.forestpolicemobileterminal.fragment.info_collection.basic_parameter.ForestryInfomationFragment;
 ...
 * 涉林重点行业添加
 */
public class ForestryKeyIndustriesAddActivity extends ParentActivity implements View.OnClickListener {
    ...
    ViewPager viewPager;
    @BindView(R.id.forestry_key_industries_pager)
    LinearLayout forestryKeyIndustriesPager;

    private List<Fragment> pageViews;
    @Override
    protected int layoutResID() {
        return R.layout.activity_forestry_key_industries_add;
    }
    ...
    private void addFragmentPager() {
        ...
        for(int i=0;i<2;i++){
            ...
            switch (i){
                case 0:
                    fragment=new ForestryInfomationFragment();
                    break;

                case 1:
                    fragment=new ForestryAttachmentFragment();
                    break;
            }
